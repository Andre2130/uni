...
class Bank2Widget extends StatefulWidget {
  const Bank2Widget({Key key}) : super(key: key);

  @override
  _Bank2WidgetState createState() => _Bank2WidgetState();
}

class _Bank2WidgetState extends State<Bank2Widget> {
