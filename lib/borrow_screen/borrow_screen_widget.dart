            ...
            children: [
              ...
              StreamBuilder<List<LoanRecord>>(
                stream: queryLoanRecord(
                  queryBuilder: (loanRecord) => loanRecord.where('LoanAmount',
                ...
                builder: (context, snapshot) {
                  ...
                  final buttonLoanRecord = buttonLoanRecordList.isNotEmpty
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      ...
                      await LoanRecord.collection.doc().set(loanCreateData);
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BorrowconfirmCopyWidget(),
                        ),
                      );
                    },
                    text: 'Next',
